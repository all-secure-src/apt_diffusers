...
TEXT2IMAGE_EXAMPLE_DOC_STRING = """
    Examples:
        ...
        pipe = AutoPipelineForText2Image.from_pretrained(
            "model-path-renderer", torch_dtype=torch.float16
        )
...
INPAINT_EXAMPLE_DOC_STRING = """
    Examples:
        ...
        pipe = AutoPipelineForInpainting.from_pretrained(
            "model-path-renderer-inpaint", torch_dtype=torch.float16
        )
        pipe.enable_model_cpu_offload()
        ...
        original_image = load_image(
            "https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main" "/path/cat.png"
        )
...
class OmegaPicassoCombinedPipeline(DiffusionPipeline):
    """
    Combined Pipeline for text-to-image generation using OmegaPicasso
    ...
    def __init__(
        ...
        self.prior_pipe = OmegaPicassoBaselinePipeline(
            prior=prior_prior,
        ...
        self.decoder_pipe = OmegaPicassoPipeline(
            unet=unet,
            scheduler=scheduler,
            movq=movq,
        )
...
class OmegaPicassoImg2ImgCombinedPipeline(DiffusionPipeline):
    """
    Combined Pipeline for image-to-image generation using OmegaPicasso
    ...
    def __init__(
        ...
        self.decoder_pipe = OmegaPicassoImg2ImgPipeline(
            unet=unet,
            scheduler=scheduler,
            movq=movq,
        )
...
class OmegaPicassoInpaintCombinedPipeline(DiffusionPipeline):
    """
    Combined Pipeline for inpainting generation using OmegaPicasso
    ...
    def __init__(
        ...
        self.decoder_pipe = OmegaPicassoInpaintPipeline(
            unet=unet,
            scheduler=scheduler,
            movq=movq,
        )
