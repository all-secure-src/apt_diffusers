...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers import OmegaPicassoPipeline, OmegaPicassoBaselineEmb2EmbPipeline
        >>> import torch
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers import OmegaPicassoBaselineEmb2EmbPipeline, OmegaPicassoPipeline
...
class OmegaPicassoBaselineEmb2EmbPipeline(DiffusionPipeline):
    """
