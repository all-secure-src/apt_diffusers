...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers import OmegaPicassoImg2ImgPipeline, OmegaPicassoBaselinePipeline
        ...
        >>> pipe = OmegaPicassoImg2ImgPipeline.from_pretrained(
...
class OmegaPicassoImg2ImgPipeline(DiffusionPipeline):
    """
